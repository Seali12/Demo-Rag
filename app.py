...
def create_and_save_index(texts, index_name):#probar otro embedding on mas tokens
    ...
    #embeddings = OllamaEmbeddings(model="nomic-embed-text") #max_seq_length=512
...
def load_index(index_name):                                                                      
    embeddings = HuggingFaceEmbeddings(model_name="sentence-transformers/all-MiniLM-L6-v2", model_kwargs={"device": "cpu"} )#max_seq_length=512
